...
NGame = {
	...
	HANDS_OFF_START_TAG = "S05",					-- tag for player country for -hands_off runs. use an existing tag that is less likely to affect the game
...
NDiplomacy = {
	...
	TENSION_TIME_SCALE_START_DATE = "2015.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
